...
public class DeletePageTwo extends LaunchSalesForceUrl{
	public DeletePageTwo(ChromeDriver driver,ExtentTest node)
	{
		this.driver=driver;
		this.node=node;
	}
	public DeletePageTwo clickOnToggle() throws IOException
	{
	try {
	...
	public DeletePageTwo clickViewAll() throws IOException {
	try {
	...
	return this;
	 	...
	 	public DeletePageTwo scrollElement()
	 	{
	 	...
	 	public DeleteIndividuals enterIndividual() throws IOException {
	 		try {
	...
	return new DeleteIndividuals(driver, node);
	}
